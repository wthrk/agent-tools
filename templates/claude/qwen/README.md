...
- [original-pod.md](/Users/ya/.agent-tools/templates/claude/qwen/original-pod.md): last known working pod configuration
...
Set `template_id` in [runpod.yaml](/Users/ya/.agent-tools/templates/claude/qwen/runpod.yaml) to your RunPod Serverless template id, then run:
...
- For the previously working `B200 + 262144` pod flow, use [recreate-original-pod.sh](/Users/ya/.agent-tools/templates/claude/qwen/recreate-original-pod.sh).
